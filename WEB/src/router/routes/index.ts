...
import { GB28181_ROUTE_MODULE, FACE_MANAGE_ROUTE, PLATE_MANAGE_ROUTE, RECORD_SPACE_MANAGE_ROUTE, SNAP_SPACE_MANAGE_ROUTE, SAM_MODEL_SETUP_ROUTE, PAGE_NOT_FOUND_ROUTE, REDIRECT_ROUTE } from '@/router/routes/basic'
